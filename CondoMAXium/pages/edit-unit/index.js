...
const EditUnitPage = () => {
  ...
  const handleDBChange = async (event) => {
    ...
    const updatedUnit = {
      ...unit,
      first_name_tenant:
        unit.occupied_by === "Owner" ? "" : unit.first_name_tenant,
      last_name_tenant:
        unit.occupied_by === "Owner" ? "" : unit.last_name_tenant,
      ...
      condo_fee_total:
        parseFloat(unit.condo_fee_sqft) * parseFloat(unit.size) +
        parseFloat(unit.parking_fee, 10),
    };
