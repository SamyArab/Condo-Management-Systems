...
//All the handleChange methods needed (in order)
    ...
    const handleSubmitVerification = (event) => {
        ...
        const isFormValid =
            ...
            profileType &&
            inputFields.every(
            (field) => field.name && field.unitId && field.owner && field.occupant && field.unitSize
        );
        ...
        <Container className={styles.unitsContainer} maxWidth="sm">
            ...
            <Grid container spacing={2}> 
                <Grid item xs={12} sm={8}>
                    <Typography variant="h4" component="h1" className={styles.profileFormHeader}>
                        Profile Information
                    </Typography>
                </Grid>
                ...
                <Grid item xs={12}>
                    <form >
                        ...
                        <Box className={styles.unitsBox}>
                            <Typography variant="h5" component="h5" className={styles.textFeildDesc}>
                                Properties
                            </Typography>
                                ...
                                return (
                                    <div key={index}>
                                        ...
                                        <Grid container spacing={1}>
                                            ...
                                            <Grid item xs={12} sm={3} className={styles.searchGrid}>
                                                <TextField
                                                    required
                                                    name='name'
                                                    label="Building Name"
                                            ...
                                            <Grid item xs={12} sm={2} className={styles.searchGrid}>
                                                <TextField
                                                    required
                                                    name='unitId'
                                                    type='text'
                                            ...
                                            <Grid item xs={12} sm={2} className={styles.searchGrid}>
                                                <FormControl required variant="filled" fullWidth>
                                                    ...
                                                    >
                                                        ...
                                                        <MenuItem value={'The owner'}>The owner</MenuItem>
                            ...
                            <Typography size="large" className={styles.textFeildDesc}>
                                Further information about the properties concenerning yourself can be added after the completion of this form. 
                            </Typography>
                        ...
                        <Button type='submit' onClick={handleSubmitVerification}>Submit</Button>
                        ...
                        >
                            ...
                            <DialogContent>
                                <DialogContentText>
                                    Further information can be added afterwards about the units that 
                                    concern yourself and the payment information. You will also be able
                                    to change the current information if there is an error.
                                </DialogContentText>
                            </DialogContent>
                            <DialogActions>
